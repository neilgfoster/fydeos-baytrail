#!/bin/sh
# iconia-power-diag.sh — READ-ONLY power/battery/charging survey of the LIVE eMMC
...
#
# Run from the crosh host:  ssh -i /tmp/ik root@192.168.1.31 'sh -s' < iconia-power-diag.sh
