#!/bin/sh
# iconia-bt-sco-deploy.sh — install the SCO-transport-routing hci_uart module on the
...
say "at hci0 bring-up (before Floss). After reboot, run: iconia-bt-sco-verify.sh"
sync
reboot
