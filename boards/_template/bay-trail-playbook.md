...
[`../iconia-w4-820/findings.md`](../iconia-w4-820/findings.md) and its
[`hardware-status.md`](../iconia-w4-820/hardware-status.md).
...
- Fix-location legend: [`../../docs/hardware-status-legend.md`](../../docs/hardware-status-legend.md).
- New-board procedure: [`../../docs/adding-a-board.md`](../../docs/adding-a-board.md).
