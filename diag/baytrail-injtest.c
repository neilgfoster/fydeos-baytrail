/* baytrail-injtest.c — one-shot: does a uinput-injected Ctrl+Alt+T open crosh?
 ...
 * the daemon.  Build: gcc -O2 -static -o baytrail-injtest baytrail-injtest.c
 */
#define _GNU_SOURCE
#include <fcntl.h>
...
int main(void) {
    ...
    strcpy(us.name, "baytrail-injtest");
