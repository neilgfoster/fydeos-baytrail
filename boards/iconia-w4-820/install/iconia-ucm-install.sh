#!/bin/sh
# Install self-contained bytcr-rt5640 UCM on the FydeOS rootfs + restart CRAS.
D=/usr/share/alsa/ucm2/conf.d/bytcr-rt5640
mount -o remount,rw / || { echo "remount rw FAILED"; exit 1; }
mkdir -p "$D"
cat > "$D/bytcr-rt5640.conf" <<'EOF'
Syntax 4

Comment "Acer Iconia W4-820 bytcr-rt5640"
SectionUseCase."HiFi" {
	File "HiFi.conf"
	Comment "Default"
}
...
EOF
ln -sfn bytcr-rt5640 /usr/share/alsa/ucm2/conf.d/bytcrrt5640
sync
mount -o remount,ro / 2>/dev/null || true
echo "installed:"; ls -la "$D"
restart cras 2>/dev/null || stop cras 2>/dev/null; start cras 2>/dev/null || true
sleep 2
echo UCM-INSTALL-DONE
